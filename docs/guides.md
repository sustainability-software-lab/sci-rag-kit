...
[<span class="srag-row__title">Operations</span><span class="srag-row__copy">Back up, restore, snapshot, delete, garbage-collect, and re-embed a changing corpus.</span>](operations.md){ .srag-row }
