...
Development happens in the open, so the issue tracker milestones say what comes next. The roadmap records the evidence required before planned work can ship.
